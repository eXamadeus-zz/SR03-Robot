...
//*****************************************************************************
//
// Configure the UART and its pins.  This must be called before printf().
//
//*****************************************************************************
void
ConfigureUART(void)
...
main(void)
{
    ...
    //
    printf("\033[2JMPU9150 Raw Example\n");
    ...
    printf("\033[2J\033[H");
    printf("MPU9150 9-Axis Simple Data Application Example\n\n");
    printf("\033[20GX\033[31G|\033[43GY\033[54G|\033[66GZ\n\n");
    printf("Accel\033[8G|\033[31G|\033[54G|\n\n");
    printf("Gyro\033[8G|\033[31G|\033[54G|\n\n");
    printf("Mag\033[8G|\033[31G|\033[54G|\n\n");
    printf("\n\033[20GRoll\033[31G|\033[43GPitch\033[54G|\033[66GYaw\n\n");
    printf("Eulers\033[8G|\033[31G|\033[54G|\n\n");

    printf("\n\033[17GQ1\033[26G|\033[35GQ2\033[44G|\033[53GQ3\033[62G|"
               "\033[71GQ4\n\n");
    printf("Q\033[8G|\033[26G|\033[44G|\033[62G|\n\n");
    ...
    while(1)
    {
        ...
        if(g_ui32PrintSkipCounter >= PRINT_SKIP_COUNT)
        {
            ...
            //
            printf("\033[5;17H%3d.%03d", i32IPart[0], i32FPart[0]);
            printf("\033[5;40H%3d.%03d", i32IPart[1], i32FPart[1]);
            printf("\033[5;63H%3d.%03d", i32IPart[2], i32FPart[2]);

            //
            // Print the angular velocities in the table.
            //
            printf("\033[7;17H%3d.%03d", i32IPart[3], i32FPart[3]);
            printf("\033[7;40H%3d.%03d", i32IPart[4], i32FPart[4]);
            printf("\033[7;63H%3d.%03d", i32IPart[5], i32FPart[5]);

            //
            // Print the magnetic data in the table.
            //
            printf("\033[9;17H%3d.%03d", i32IPart[6], i32FPart[6]);
            printf("\033[9;40H%3d.%03d", i32IPart[7], i32FPart[7]);
            printf("\033[9;63H%3d.%03d", i32IPart[8], i32FPart[8]);

            //
            // Print the Eulers in a table.
            //
            printf("\033[14;17H%3d.%03d", i32IPart[9], i32FPart[9]);
            printf("\033[14;40H%3d.%03d", i32IPart[10], i32FPart[10]);
            printf("\033[14;63H%3d.%03d", i32IPart[11], i32FPart[11]);

            //
            // Print the quaternions in a table format.
            //
            printf("\033[19;14H%3d.%03d", i32IPart[12], i32FPart[12]);
            printf("\033[19;32H%3d.%03d", i32IPart[13], i32FPart[13]);
            printf("\033[19;50H%3d.%03d", i32IPart[14], i32FPart[14]);
            printf("\033[19;68H%3d.%03d", i32IPart[15], i32FPart[15]);
